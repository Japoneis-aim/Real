...
namespace cs2 {
	...
	constexpr std::uintptr_t m_iHealth = 0x334;        // health
	constexpr std::uintptr_t m_iTeamNum = 0x3C3;       // team
	constexpr std::uintptr_t m_lifeState = 0x338;      // alive?
	constexpr std::uintptr_t m_vOldOrigin = 0x12B4;    // position
	constexpr std::uintptr_t m_vecAbsVelocity = 0x12C0;
	constexpr std::uintptr_t m_vecViewOffset = 0x12CC; // eye position
