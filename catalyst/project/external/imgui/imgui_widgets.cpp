...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (std::abs(Value->second.a) < 0.9f)
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1), check_bb.Max - ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1), ImColor(53, 147, 251, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::KeyBind(const char* label, int* Key, int* KeyState)
{
    ...
    window->DrawList->AddCircleFilled(circleCenter, radius, IM_COL32(53, 147, 251, (int)(GetStyle().Alpha * 255)), 360);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int itemcount)
{
    ...
    if (!(flags & ImGuiComboFlags_NoPreview))
    {
        ...
        window->DrawList->AddRect(bb.Min, bb.Max, GetColorU32(ImGuiCol_Border), 5);
        window->DrawList->AddCircleFilled(ImVec2(bb.Max.x - 14, bb.Min.y + total_bb.GetHeight() / 2), Value->second.a, ImColor(53, 147, 251, (int)(GetStyle().Alpha * 255)), 360);
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x)
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(1, 0), ImVec2(frame_bb.Min.x + Value->second.anim + 1, frame_bb.Max.y), ImColor(53, 147, 251, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    const ImU32 col_hues[6 + 1] = { IM_COL32(255,255,255,style_alpha8), IM_COL32(255,255,0,style_alpha8), IM_COL32(0,255,0,style_alpha8), IM_COL32(0,255,255,style_alpha8), IM_COL32(255,255,255,style_alpha8), IM_COL32(255,0,255,style_alpha8), IM_COL32(255,255,255,style_alpha8) };
